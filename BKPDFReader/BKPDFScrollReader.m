...
- (void)pinScrollToSuperView
{
    ...
    [self.contentScroll blk_pinViewToSuperviewEdgesWithInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
}
...
- (void)pinReaderToScrollView
{
    ...
    [self.readerView blk_pinViewToSuperviewEdgesWithInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
}
...
- (void)pinToSuperView
{
    ...
    [self blk_pinViewToSuperviewEdgesWithInsets:UIEdgeInsetsMake(0, 0, 0,0)];
}
